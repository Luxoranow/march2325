...
export default function CardEditor({ isMasterTemplate = false }: { isMasterTemplate?: boolean }) {
  // Add mounted state
  ...
  // Initialize with empty data for new card
  ...
  const saveCard = async () => {
    try {
      ...
      const cardName = isMasterTemplate 
        ...
        : (cardData.personal.name || 'Untitled Card');
    ...
    return (
      ...
      >
        ...
        <Box sx={{ 
          ...
          >
            {isMasterTemplate ? "TEAM MEMBER" : "PERSONAL"}
          </Typography>
  ...
  return (
    <Box sx={{ py: 4 }}>
      ...
      >
        {isMasterTemplate ? "COMPANY MASTER TEMPLATE" : "DIGITAL CARD EDITOR"}
      </Typography>
      
      {isMasterTemplate && (
        <Box sx={{ mb: 4, px: 4 }}>
          <Alert severity="info" sx={{ mb: 2 }}>
            This template will be used as the base for all team member cards. 
            Define company information, branding, and social accounts that should be consistent across your team.
          </Alert>
        </Box>
      )}
      ...
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} md={7}>
            ...
            <AccordionDetails>
              <Stack spacing={3}>
                ...
                <Box>
                  ...
                  >
                    {isMasterTemplate ? "TEAM MEMBER PHOTO PLACEHOLDER" : "PROFILE PHOTO"}
                  </Typography>
                    ...
                    >
                      {cardData.personal.photo ? (
                        ...
                        <Typography variant="caption" sx={{ color: '#666666' }}>
                          {isMasterTemplate ? "PHOTO" : (cardData.personal.name ? cardData.personal.name.charAt(0) : 'No photo')}
                        </Typography>
                      )}
                    </Box>
                    <Button
                ...
                <TextField
                  ...
                  placeholder={isMasterTemplate ? "This will be replaced by team member name" : ""}
                  InputLabelProps={{
                    sx: { 
                      ...editorStyles.input
                    }
                ...
                <TextField
                  ...
                  placeholder={isMasterTemplate ? "e.g., Marketing Specialist" : ""}
                  InputLabelProps={{
                    sx: { 
                      ...editorStyles.input
                    }
                ...
                <TextField
                  ...
                  placeholder={isMasterTemplate ? "e.g., firstname@yourcompany.com" : ""}
                  InputLabelProps={{
                    sx: { 
                      ...editorStyles.input
                    }
                ...
                <TextField
                  ...
                  placeholder={isMasterTemplate ? "Will be personalized for each team member" : ""}
                  InputLabelProps={{
                    sx: { 
                      ...editorStyles.input
                    }
          ...
          <Box sx={{ mt: 4, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            >
              {saving ? <CircularProgress size={24} color="inherit" /> : (isMasterTemplate ? 'SAVE TEMPLATE' : 'SAVE CARD')}
            </Button>
            {saveSuccess && (
              <Typography 
                variant="body2" 
              ...
              >
                {isMasterTemplate ? 'Template saved successfully!' : 'Card saved successfully!'}
              </Typography>
            )}
            {saveError && (
